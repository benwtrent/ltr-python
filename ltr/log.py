...
class FeatureLogger:
    ...
    def __init__(self, client, index, feature_names, feature_templates, drop_missing=True):
        self.client=client
        self.index=index
    ...
    def log_for_qid(self, qid, judgments, keywords):
        ...
        for i in range(0, 1 + (len(docIds) // BATCH_SIZE)):
            ...
            res = self.client.log_query(self.index, ids, self.feature_names, self.feature_templates, params)
